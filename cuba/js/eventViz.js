...
EventVis = function (_presElement, _data, _eventHandler) {
    ...
    this.margin = { top: 0, right: 40, bottom: 80, left: 50 },
    this.width = getInnerWidth2(this.presElement) - this.margin.left - this.margin.right,
...
EventVis.prototype.updateArticles = function () {
    ...
    $('.art').remove();
    var article = this.articleBlock.html('').selectAll('div')
