...
namespace Cuba.Controllers
{
    public class InsertController : Controller
    {
        ...
        public void Index()
        {
            ...
            while (true)
            {
                url = "http://api.nytimes.com/svc/search/v2/articlesearch.json?callback=svc_search_v2_articlesearch&q=cuba+thaw&begin_date=20141217&end_date=20150425&sort=oldest&fl=_id%2Cword_count%2Cpub_date%2Cheadline%2Cmultimedia%2Csource%2Clead_paragraph%2Csnippet%2Cweb_url&page=" + page + "&api-key=91cd0f1d5b7d95ae8c92eccb516df20b:15:71932119";
